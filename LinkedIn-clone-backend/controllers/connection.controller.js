...
import ConnectionRequest from "../models/connectionRequest.model.js";
    ...
    export const acceptConnectionRequest = async(req, res) =>
    {
        try {
            ...
            {
                return res.status(403).json({message: "Not athorized to accept this request"});
            }
            ...
            console.error("Error in accept connectionRequest controller:", error);
            res.status(500).json({message: "Server error"});
        }
    };
    ...
    export const rejectConnectionRequest = async ( req, res ) =>
    {
        try {
            ...
            console.error("Error in rejectConnectionRequest controller");
            res.status(500).json({message: "Server error"});
        }
    };
    ...
    export const getConnectionRequests = async(req, res) =>
    {
      try {
        ...
        const requests = await ConnectionRequest.find({recipient: userId, status:'pending'}).populate(
            "sender",  "name userName profilePicture headline connection"
        );
        res.json(requests);
      }
      catch(error)
      {
        console.error("Error in getConnectionRequests controller");
        res.status(500).json({message: "Server error"});
      }
    };
    ...
    export const getUserConnections = async(req, res) =>
    {
        try {
            ...
            const user = await ConnectionRequest.findById(userId)
